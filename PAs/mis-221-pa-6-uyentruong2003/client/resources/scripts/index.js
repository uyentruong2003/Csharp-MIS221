...
function handleEditClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg btn-cancel\" onclick=\"handleCancelSave("+myBook.id+")\">Cancel</button>"
...
function handleNewClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg btn-cancel\" onclick=\"handleEditSave("+myBook.id+")\">Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
